...
furious7 = Movie("Furious7", date(2015, 4, 2))
...
furious7.actors = [dwayne_johnson]
pain_and_gain.actors = [dwayne_johnson, mark_wahlberg]

#add contact_details to actors
...
dwayne_contact_2 = ContactDetails("421 444 2323", "West Hollywood", dwayne_johnson)
